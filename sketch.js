...
function setup() {
 ...
 box2=new Squares(550,470,30,30)
  ...
  box6=new Squares(490,440,30,30)
  box7=new Squares(520,440,30,30)
  box8=new Squares(550,440,30,30)
  box9=new Squares(570,440,30,30)
  box10=new Squares(500,410,30,30)
  box11=new Squares(520,410,30,30)
  box12=new Squares(550,410,30,30)
  box13=new Squares(550,380,30,30)
  box14=new Squares(520,380,30,30)
  box15=new Squares(530,350,30,30)
